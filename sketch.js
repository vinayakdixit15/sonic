...
function preload(){
  ...
  trex_collided=loadAnimation("hurt_by_modernlixes_db0c9e2-fullview-removebg-preview.png");
  
  groundImage = loadImage("images.jpg");
  
  cloudImage = loadImage("images.jpg");
  
  obstacle1 = loadImage("Ring_SatSR.png");
...
function setup() {
  ...
  trex = createSprite(80,100,20,50);
